...
#########################################
./geth --networkid 122018  --nodiscover --nodekey "./nodedata/NodeIdDerived.key" --datadir "./nodedata" --cache 512 --port 30303 --rpc --rpcaddr "0.0.0.0"  --rpcport "8545" --rpccorsdomain "*"   --rpcapi "eth,miner,personal,net,web3,clique" --ws --wsaddr "0.0.0.0" --wsapi "eth,miner,personal,net,web3,clique" --wsorigins "*"  --targetgaslimit 4700000 --gasprice 0 --etherbase "0x4863828C08e95bf1a1128352BC022251C85eCfFd" --unlock "0x4863828C08e95bf1a1128352BC022251C85eCfFd" --password "./nodedata/minerAccoutPass.txt" --mine --minerthreads 1 $BootnodeOptions
